...
// callAPI executes the request.
func (c *Client) callAPI(request *http.Request) (resp *http.Response, err error) {
	if c.cfg.Debug {
	...
	if request.Method == http.MethodGet {
		attempts += c.cfg.GetRequestRetries
	}
	...
	for i := attempts; i > 0; i-- {
		...
		if c.cfg.Debug {
			log.Printf("\nError calling API: %v. Retries remaining: %d\n", err, i)
		}
		if i > 1 {
