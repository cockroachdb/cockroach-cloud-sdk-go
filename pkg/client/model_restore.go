...
type Restore struct {
	...
	Opts    *RestoreOpts   `json:"opts,omitempty"`
...
// GetBackupEndTime returns the BackupEndTime field value if set, zero value otherwise.
func (o *Restore) GetBackupEndTime() time.Time {
	if o == nil || o.BackupEndTime == nil {
		var ret time.Time
		return ret
	}
...
// SetBackupEndTime gets a reference to the given time.Time and assigns it to the BackupEndTime field.
...
// GetDestinationClusterName returns the DestinationClusterName field value if set, zero value otherwise.
func (o *Restore) GetDestinationClusterName() string {
	if o == nil || o.DestinationClusterName == nil {
		var ret string
		return ret
	}
...
// SetDestinationClusterName gets a reference to the given string and assigns it to the DestinationClusterName field.
...
// SetOpts gets a reference to the given RestoreOpts and assigns it to the Opts field.
