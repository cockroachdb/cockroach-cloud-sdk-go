...
### NewEditEgressRuleBody

`func NewEditEgressRuleBody() *EditEgressRuleBody`

NewEditEgressRuleBody instantiates a new EditEgressRuleBody object.
...
`func (o *EditEgressRuleBody) GetDescription() string`

GetDescription returns the Description field if non-nil, zero value otherwise.

### SetDescription

`func (o *EditEgressRuleBody) SetDescription(v string)`

SetDescription sets Description field to given value.

### GetDestination

`func (o *EditEgressRuleBody) GetDestination() string`

GetDestination returns the Destination field if non-nil, zero value otherwise.

### SetDestination

`func (o *EditEgressRuleBody) SetDestination(v string)`

SetDestination sets Destination field to given value.

### GetIdempotencyKey

`func (o *EditEgressRuleBody) GetIdempotencyKey() string`

GetIdempotencyKey returns the IdempotencyKey field if non-nil, zero value otherwise.

### SetIdempotencyKey

`func (o *EditEgressRuleBody) SetIdempotencyKey(v string)`

SetIdempotencyKey sets IdempotencyKey field to given value.

### GetPaths

`func (o *EditEgressRuleBody) GetPaths() []string`

GetPaths returns the Paths field if non-nil, zero value otherwise.

### SetPaths

`func (o *EditEgressRuleBody) SetPaths(v []string)`

SetPaths sets Paths field to given value.

### GetPorts

`func (o *EditEgressRuleBody) GetPorts() []int32`

GetPorts returns the Ports field if non-nil, zero value otherwise.

### SetPorts

`func (o *EditEgressRuleBody) SetPorts(v []int32)`

SetPorts sets Ports field to given value.

### GetType

`func (o *EditEgressRuleBody) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### SetType

`func (o *EditEgressRuleBody) SetType(v string)`
