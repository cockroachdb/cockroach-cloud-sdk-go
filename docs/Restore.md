...
------------ | ------------- | ------------- | -------------
**BackupEndTime** | Pointer to **time.Time** | The timestamp at which the backup data was captured. | [optional] 
...
**DestinationClusterName** | Pointer to **string** | The name of the cluster to which the restore is being applied. | [optional] 
...
**Opts** | Pointer to [**RestoreOpts**](RestoreOpts.md) |  | [optional] 
**SourceClusterName** | Pointer to **string** | The name of the cluster from which the backup was taken. | [optional] 
...
`func (o *Restore) GetOpts() RestoreOpts`

GetOpts returns the Opts field if non-nil, zero value otherwise.

### SetOpts

`func (o *Restore) SetOpts(v RestoreOpts)`
