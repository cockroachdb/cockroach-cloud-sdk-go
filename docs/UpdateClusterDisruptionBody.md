...
### NewUpdateClusterDisruptionBody

`func NewUpdateClusterDisruptionBody() *UpdateClusterDisruptionBody`

NewUpdateClusterDisruptionBody instantiates a new UpdateClusterDisruptionBody object.
...
`func (o *UpdateClusterDisruptionBody) GetRegionalDisruptorSpecifications() []RegionalDisruptorSpecification`
...
`func (o *UpdateClusterDisruptionBody) SetRegionalDisruptorSpecifications(v []RegionalDisruptorSpecification)`
