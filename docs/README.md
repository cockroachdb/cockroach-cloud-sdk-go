...
[EgressPrivateEndpointsApi](docs/EgressPrivateEndpointsApi.md) | **UpdateEgressPrivateEndpoint** | **Patch** /api/v1/clusters/{cluster_id}/networking/egress-private-endpoints/{id} | Update egress private endpoint domain names
